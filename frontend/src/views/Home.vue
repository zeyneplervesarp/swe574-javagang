<template>
  <div>
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <p class="lead text-white">
                ...
                other services and be part of a growing community where time is
                the only currency. Here are a few services.
              </p>
    ...
    <section class="section section-lg pt-lg-0 mt--300" v-if="userLoggedIn">
      <!-- <services  :filter="'featured'"></services> -->
      <services  :filter="'recommended'"></services>
      <!-- <recommendations></recommendations> -->
    </section>
        ...
        <card gradient="primary" no-body shadow-size="lg" class="border-0">
          <div class="p-5">
            <div class="row align-items-center">
              <div class="col-lg-8">
                <h3 class="text-white">Want to take a look at all services?</h3>
