...
public class ServiceServiceUnitTests {
    ...
    public void Service_ShouldThrowError_IfCreditAboveThreshold() {
        ...
        var testService = new ServiceDto(1L, "Test Service", ",", LocationType.Physical, "", LocalDateTime.of(2022, 02, 01, 10, 00), 3, 20, 0, 1L, "", 00.00, 00.00, null, ServiceStatus.ONGOING, null, null, null, null, 0l,null, false, new Date());
