...
public interface ServiceRepository extends JpaRepository<Service, Long>, CreatedQueryableRepository<Service> {
    ...
    List<Service> findAllByCreatedBetween(Date createdGt, Date createdLt, Pageable pageable);
}